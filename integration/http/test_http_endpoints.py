# TEST DISABLED: Brak fixture 'httpbin' oraz niepotrzebne testy HTTP w tym projekcie.
# Aby przywrócić testy, odkomentuj i uzupełnij brakujące zależności/fixture.
